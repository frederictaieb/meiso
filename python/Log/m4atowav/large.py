...
import os
import shutil
import utility.files as f
import datetime

def lg_wav_to_txt(path = "1.wav"):
    # Input audio file to be sliced 

    audio = AudioSegment.from_wav("ta.wav") 
    ''' 
    ...
    for i in range(0, 2 * n, interval): 
        ...
        try:	 
            ...
            d = datetime.timedelta(milliseconds=start)
...
if __name__ == '__main__': 
    ...
    path = input() 
    f.make_folder('audio_chunks')
    lg_wav_to_txt(path)
    f.remove_folder('audio_chunks')